...
namespace JohnsBugTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //sending in a string to the post ("demoadmin, demopm, demodev, "demosub")
            ...
            switch (result)
            {
                ...
                default:
                    return RedirectToAction("DemoLogin", "Home");
            }
        }
        //
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var email = new MailMessage("JohnsBugTracker<jc56wrestling@yahoo.com>", model.Email)
                {
