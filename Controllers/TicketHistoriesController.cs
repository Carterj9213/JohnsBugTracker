...
namespace JohnsBugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Property,NewValue,OldValue,Changed")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Property,NewValue,OldValue,Changed")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
